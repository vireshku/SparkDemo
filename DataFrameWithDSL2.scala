...
object DataFrameWithDSL2 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val employee1 = Employee1("michael", "armbrust", "no-reply@berkeley.edu", 100000)
    val employee2 = Employee1("xiangrui", "meng", "no-reply@stanford.edu", 120000)
    val employee3 = Employee1("matei", "", "no-reply@waterloo.edu", 140000)
    val employee4 = Employee1("", "wendell", "no-reply@berkeley.edu", 160000)
